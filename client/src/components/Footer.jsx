    ...
    <>
      <footer class="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500 mt-20">
        <div class="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
          <div class="md:max-w-96">
            ...
            <p class="mt-6 text-sm">
              Erlebe die Kraft der KI mit QuickAI. <br /> Transformiere deine
              Content-Erstellung mit unserer Suite aus hochwertigen KI-Tools.
              Verfasse Artikel, generiere Bilder und optimiere deinen Workflow.
            </p>
          </div>
            ...
            <div>
              ...
              <div class="text-sm space-y-2">
                ...
                <div class="flex items-center gap-2 pt-4">
                  ...
                  />
                  <button class="bg-primary cursor-pointer w-24 h-9 text-white rounded">
                    Subscribe
                  </button>
                </div>
              </div>
        ...
        <p class="pt-4 text-center text-xs md:text-sm pb-5">
          Copyright 2025 © <a href="https://prebuiltui.com">RustyTech</a>. All
          Right Reserved.
        </p>
      </footer>
    </>
